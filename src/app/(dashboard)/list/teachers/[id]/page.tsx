          ...
          <div className=" bg-PatoSky py-6 px-4 rounded-2xl flex-1 flex gap-4 ">
            ...
            <div className="w-1/3">
              <Image
                ...
                width={144}
                height={144}
                className=" w-36 h-36 object-cover  rounded-full sng-pag-fx "
              />
            </div>
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        ...
        <div className="bg-white bg-dark p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            ...
            <Link
              className=" p-3 rounded-md bg-PatoYellowLight bg-dark-2 "
            ...
            <Link
              className=" p-3 rounded-md bg-pink-50 bg-dark "
            ...
            <Link
              className=" p-3 rounded-md bg-PatoSkyLight bg-dark-2 "
