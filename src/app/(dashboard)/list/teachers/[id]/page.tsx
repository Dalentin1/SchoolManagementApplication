      ...
      <div className="w-ful xl:w-2/3">
        ...
        <div className=" flex flex-col lg:flex-row gap-4 ">
          ...
          <div className=" bg-PatoSky py-6 px-4 rounded-md flex-1 flex gap-4 ">
            ...
            <div className="w-1/3">
              <Image src="https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="User Pic" width={144} height={144} className=" w-36 h-36 object-cover  rounded-full sng-pag-fx "/>
            </div>
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
             ...
             <div className="flex items-center gap-4">
                ...
                {/* TEACHER NAME */}
                <h1 className="text-xl font-semibold">Patrick Nnodu</h1>

                <FormModal table="teacher" type="update" data={ {
                      id: 1,
                     username: "patricknnodu",
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        ...
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            ...
            <Link className=" p-3 rounded-md bg-PatoSkyLight" href="/">Teacher&apos;s Classes</Link>

            <Link className=" p-3 rounded-md bg-PatoPurpleLight" href="/">Teacher&apos;s Students</Link>

            <Link className=" p-3 rounded-md bg-PatoYellowLight "  href="/">Teacher&apos;s Lessons</Link>

            <Link className=" p-3 rounded-md bg-pink-50 " href="/">Teacher&apos;s Exams</Link>

            <Link className=" p-3 rounded-md bg-PatoSkyLight " href="/">Teacher&apos;s Assignments</Link>
          </div>
