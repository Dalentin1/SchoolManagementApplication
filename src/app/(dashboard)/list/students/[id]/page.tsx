      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        ...
        <div className="bg-white bg-dark p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            ...
            <Link className=" p-3 rounded-md bg-PatoPurpleLight bg-dark " href={`/list/teachers?classId=${2}`}>Student&apos;s Teachers</Link>

            <Link className=" p-3 rounded-md bg-pink-50 bg-dark " href="/">Student&apos;s Exams</Link>
